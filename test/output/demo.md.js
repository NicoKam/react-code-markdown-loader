...
export const code = ("import md from './test.md';\nimport demo from './demo/demo.md';\n\nconsole.log(md);\nconsole.log(demo);");
export const allCode = ([{"content":"import NewsStatistic from \"@ali-whale-mobile/photo-swipper\";\n\nconst Demo = props => {\n  return <NewsStatistic read=\"2091\" star=\"5\" />;\n};\n\nexport default Demo;","type":"jsx"}]);
